  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-screen">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 text-center py-20">
        ...
        <h3 className="text-xl font-medium text-gray-900">Company Profile Setup</h3>
        <p className="text-gray-500 mt-2">Please complete your company profile to start posting jobs.</p>
        <button className="mt-6 bg-gray-900 text-white px-6 py-2 rounded-lg font-medium hover:bg-gray-800 transition-colors">
          Complete Setup
        </button>
      </div>
    </div>
